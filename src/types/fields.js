...
export const fields = /** @type {ResourceFieldDefs} */ ({
  ...
  sampling: [
    ...
    { key: 'cost_enabled', label: 'Cost enabled', type: 'boolean', desc: 'Whether cost calculation is enabled for this sampling', aliases: ['cost_enabled', 'costEnabled'], visible: true, card: { show: true, order: 36 } },
    { key: 'computed_total', label: 'Computed Total (INR)', type: 'currency', desc: 'Computed total amount (total_count * max(avg_weight,1kg) * fish_cost)', aliases: ['computed_total', 'computedAmount'], visible: false, card: { show: true, order: 40 }, formatter: 'currency' },
